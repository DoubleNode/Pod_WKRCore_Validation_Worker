Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/Four23Creative/Pod_WKRCore_Validation_Worker"
  ...
  s.source = { :git => "https://github.com/Four23Creative/Pod_WKRCore_Validation_Worker.git", :tag => "#{s.version}" }
